...
plt.tight_layout()
plt.savefig('variant_distribution_bar.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('spike_mutations.png', dpi=300, bbox_inches='tight')
...
spike_muts.to_csv('spike_mutations.csv', index=False)
